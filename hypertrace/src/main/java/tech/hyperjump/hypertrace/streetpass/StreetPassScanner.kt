...
import tech.hyperjump.hypertrace.bluetooth.BLEScanner
import tech.hyperjump.hypertrace.logging.CentralLog
import tech.hyperjump.hypertrace.services.BluetoothMonitoringService.Companion.infiniteScanning
...
//        discoverer = BLEDiscoverer(context, serviceUUIDString)
    ...
    fun startScan() {
        ...
        BluetoothServiceUtil.broadcastStatusReceived(context, statusRecord)
    ...
    inner class BleScanCallback : ScanCallback() {
        ...
        private fun processScanResult(scanResult: ScanResult?) {
            ...
            scanResult?.let { result ->
                ...
                BluetoothServiceUtil.broadcastDeviceScanned(context, device, connectable)
            }
        }
