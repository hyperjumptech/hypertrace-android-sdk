...
import tech.hyperjump.hypertrace.bluetooth.gatt.*
import tech.hyperjump.hypertrace.logging.CentralLog
import tech.hyperjump.hypertrace.scheduler.Scheduler
import tech.hyperjump.hypertrace.services.BluetoothMonitoringService
import tech.hyperjump.hypertrace.services.BluetoothMonitoringService.Companion.PENDING_ADVERTISE_REQ_CODE
import tech.hyperjump.hypertrace.services.BluetoothMonitoringService.Companion.PENDING_BM_UPDATE
import tech.hyperjump.hypertrace.services.BluetoothMonitoringService.Companion.PENDING_HEALTH_CHECK_CODE
import tech.hyperjump.hypertrace.services.BluetoothMonitoringService.Companion.PENDING_PURGE_CODE
import tech.hyperjump.hypertrace.services.BluetoothMonitoringService.Companion.PENDING_SCAN_REQ_CODE
import tech.hyperjump.hypertrace.services.BluetoothMonitoringService.Companion.PENDING_START
import tech.hyperjump.hypertrace.status.Status
import tech.hyperjump.hypertrace.streetpass.ACTION_DEVICE_SCANNED
import tech.hyperjump.hypertrace.streetpass.ConnectablePeripheral
...
internal object BluetoothServiceUtil {
    ...
    suspend fun getHandShakePin(onSuccess: (result: JSONObject) -> Unit, onError: (e: Throwable) -> Unit) {
        // getHandshakePin to give to authority for tracing upload
